...
# Format-classification sets must match ``siftpdf.api.routes.reports``.
...
class ReportService:
    ...
    def cleanup_expired(self) -> int:
        ...
        if count > 0:
            ...
            try:
                from siftpdf.webhooks.events import fire_report_expired
    ...
    def _generate_format(
        ...
        *,
        ...
        if fmt == "json":
            from siftpdf.reports.json_report import generate_json_from_dict

            return generate_json_from_dict(result_json)
        if fmt == "xml":
            from siftpdf.reports.xml_report import generate_xml_from_dict
    ...
    def _generate_html(  # skipcq: PY-R1000
        ...
        *,
        ...
        from siftpdf.reports.html_report import _TEMPLATE_DIR
        ...
        try:
            from siftpdf.reports.check_names import get_check_info
        ...
        if pdf_bytes is not None and detail_level != ReportDetailLevel.EXECUTIVE:
            try:
                from siftpdf.reports.page_renderer import render_annotated_pages
            ...
            try:
                from siftpdf.reports.page_renderer import render_finding_thumbnails
        ...
        if summary_page != "off" and pdf_bytes is not None:
            try:
                from siftpdf.reports.page_renderer import render_page_thumbnail_grid
    ...
    def _generate_annotated_pdf(
        ...
        """
        from siftpdf.reports.annotated_pdf_report import generate_annotated_pdf
    ...
    def _generate_annotated_pdf_markup(
        ...
        from siftpdf.api.models import ViewerAnnotation, ViewerAnnotationComment
