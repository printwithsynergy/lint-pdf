...
Usage::
    ...
    python -m siftpdf.scripts.v12_migrate_legacy --dry-run
    python -m siftpdf.scripts.v12_migrate_legacy
    python -m siftpdf.scripts.v12_migrate_legacy --tenant-id <uuid>
"""
