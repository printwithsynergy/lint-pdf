...
retry task :func:`siftpdf.queue.audit_tasks.audit_findings_async`
...
class ClaudeAuditor:
    ...
    caller (see :mod:`siftpdf.queue.audit_tasks`) schedules a
    ...
    def _audit_batch(
        ...
        *,
        ...
        if tenant_id is not None:
            try:
                from siftpdf.audit.metering import record_usage
