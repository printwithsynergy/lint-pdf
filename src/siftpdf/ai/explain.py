...
:func:`siftpdf.ai.cost_cap.check_cap_or_raise` so a tenant who has
...
raises :class:`siftpdf.ai.cost_cap.CostCapExceededError` and the
...
from siftpdf.ai.cost_cap import CostCapExceededError, check_cap_or_raise
...
def _record_usage_inline(
    ...
    *,
    ...
    Mirrors :func:`siftpdf.audit.metering.record_usage` but reuses the
