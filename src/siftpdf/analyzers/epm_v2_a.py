...
:mod:`siftpdf.epm.codes`. Tier-A findings hard-reject a job from EPM
candidacy in :func:`siftpdf.epm.scoring.score_epm_candidacy`.
...
# :data:`siftpdf.tenants.toggle_registry._DEFAULT_EPM_THRESHOLDS`.
...
def detect_a1_gamut(
    ...
    * **Default heuristic** (``profile=None``) — the analyzer falls
    ...
    """
    from siftpdf.semantic.events import ColorChangedEvent
