...
full :func:`siftpdf.queue.tasks.run_customer_audit` pass; on
...
@celery_app.task(
    bind=True,
    name="siftpdf.queue.audit_tasks.ocr_job_async",
    max_retries=None,
)
def ocr_job_async(
    self: Any,
    ...
    *,
    ...
    pages processed.
    """
    from siftpdf.ai.ocr_claude import ClaudeOCR, ocr_result_to_json
    ...
    from siftpdf.queue.tasks import _emit_feature_locked, _emit_quota_exceeded
...
@celery_app.task(
    bind=True,
    name="siftpdf.queue.audit_tasks.audit_findings_async",
...
@celery_app.task(
    name="siftpdf.queue.audit_tasks.drain_ai_audit_rerun_queue",
)
def drain_ai_audit_rerun_queue() -> int:
    ...
    """
    from siftpdf.queue.app import _drain_rerun_queue
