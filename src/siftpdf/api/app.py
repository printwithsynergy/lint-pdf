...
from siftpdf import decisions as _decisions  # noqa: F401  (registration import)
from siftpdf.api.routes import (
    admin,
    admin_health,
    admin_warming,
    ai_config,
...
def _run_migrations(database_url: str) -> None:
    ...
    from siftpdf.api.database import get_engine
...
async def _lifespan(_app: FastAPI) -> AsyncGenerator[None, None]:
    ...
    from siftpdf.api.database import dispose_db, init_db
    ...
    if database_url:
        ...
        try:
            ...
            from siftpdf.profiles.seed import (
    ...
    if redis_url:
        from siftpdf.api.middleware import configure_rate_limiter
...
def create_app() -> FastAPI:
    ...
    from siftpdf.api.middleware import RequestIdMiddleware
    ...
    from siftpdf.api.middleware_warming import WakeOnNeedMiddleware
    ...
    from siftpdf.api.metrics import mount_metrics
    ...
    if get_settings().dev_auth_enabled:
        from siftpdf.api.routes import dev_auth
