...
async def get_brand_profile(
    ...
    from siftpdf.api.cache import brand_profile_key, get_json, set_json
...
async def update_brand_profile(
    ...
    from siftpdf.api.cache import brand_profile_key
    from siftpdf.api.cache import invalidate as cache_invalidate
