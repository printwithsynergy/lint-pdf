...
async def stripe_webhook(
    ...
    """
    from siftpdf.billing.allocation import allocate_monthly, fulfill_purchase
    from siftpdf.billing.stripe_client import StripeError, verify_webhook_signature
