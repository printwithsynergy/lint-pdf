...
from siftpdf.api.models import Tenant, TenantColorConfig
...
async def upload_icc_profile(
    ...
    from siftpdf.profiles.icc.profile_manager import validate_icc_profile_bytes
...
def _invalidate_pantone_cache(tenant_id: uuid_mod.UUID) -> None:
    ...
    try:
        ...
        from siftpdf.profiles.icc.pantone_cache import invalidate
...
async def set_pantone_overrides(
    ...
    """
    from siftpdf.profiles.icc.pantone_manager import _normalize_pantone_name
...
async def list_gamut_conditions(
    ...
    from siftpdf.profiles.icc.profile_manager import get_available_conditions
