...
from siftpdf.api.ai_schemas import (
    AIConfigResponse,
...
from siftpdf.api.models import Tenant  # noqa: TC001 — needed at runtime for FastAPI Depends()
from siftpdf.api.upload_security import PRINT_READY_TYPES, validate_upload
...
async def update_ai_config(
    ...
    from siftpdf.ai.config import update_ai_config as _update
...
async def upload_reference_logo(
    ...
    from siftpdf.ai.access import check_ai_access
    from siftpdf.ai.config import add_reference_logo
...
async def delete_reference_logo(
    ...
    from siftpdf.ai.access import check_ai_access
    from siftpdf.ai.config import remove_reference_logo
