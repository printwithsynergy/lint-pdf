...
Reference: lintpdf-research/implementation-plan.md Module 2
"""
...
from siftpdf.exceptions import InvalidBoxError, InvalidPageError
...
if TYPE_CHECKING:
    from siftpdf.parser.adapter import ParserAdapter, PdfDocument, PdfPage
