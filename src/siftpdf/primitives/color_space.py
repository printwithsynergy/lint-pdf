...
from siftpdf.primitives import _ps_type4, register
...
def is_Shading(cs: Any) -> bool:
    ...
    :func:`siftpdf.primitives.object_class.is_shading`); a "shading color
...
def tint_transform_is_zero(cs: Any) -> bool:
    ...
    evaluated via :mod:`siftpdf.primitives._ps_type4` at sample points
