...
implement the Protocols defined in ``lintpdf.plugin.protocol``.
...
from lintpdf.plugin.capabilities.page_rendering import RendererBackedPageImageProvider
from lintpdf.plugin.capabilities.text_regions import GPUTextRegionProvider
