...
from grounded.queue.app import celery_app
...
@celery_app.task(  # type: ignore[untyped-decorator]
    name="grounded.queue.tasks.cleanup_expired_reports",
)
def cleanup_expired_reports() -> dict[str, Any]:
    ...
    from grounded.api.database import get_db_session
    from grounded.api.storage import get_storage
    from grounded.reports.service import ReportService
...
@celery_app.task(  # type: ignore[untyped-decorator]
    name="grounded.webhook.dispatch",
    max_retries=3,
