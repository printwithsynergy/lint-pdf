...
class PdfAValidator(BaseConformanceValidator):
    ...
    def validate(
        ...
        from grounded.conformance.pdfa._metadata import validate_metadata
        from grounded.conformance.pdfa._color import validate_color
        from grounded.conformance.pdfa._font import validate_fonts
        from grounded.conformance.pdfa._restrictions import validate_restrictions
