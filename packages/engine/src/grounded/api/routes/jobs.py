...
from grounded.api.middleware import check_rate_limit
...
from grounded.api.upload_security import PDF_TYPES, validate_upload
from grounded.tenants.models import RATE_LIMIT_WARN_THRESHOLD
...
def _send_rate_warning_if_needed(tenant: Tenant, usage: object) -> None:  # skipcq: PY-R1000
    ...
    """
    from grounded.api.middleware import UsageInfo, get_redis_client
    from grounded.tenants.models import RATE_LIMIT_OVERAGE_THRESHOLD
    ...
    try:
        if threshold == RATE_LIMIT_OVERAGE_THRESHOLD and usage.overage_enabled:
            from grounded.email.service import send_overage_started
            ...
            from grounded.email.service import send_rate_limit_warning
