...
def get_credit_balance(tenant_id: uuid.UUID, db: Session) -> CreditBalance:
    ...
    from grounded.api.models import AIBillingMode, AIUsageLog, TenantAIConfig, TenantAICreditPackage
...
def check_ai_credits(
    ...
    """
    from grounded.api.models import AIBillingMode, TenantAIConfig
