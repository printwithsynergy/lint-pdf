...
class TestFontEmbedding:
    ...
    def test_embedded_font_no_finding(self) -> None:
    ...
    def test_not_embedded_triggers_aground(self) -> None:
    ...
    def test_standard_14_not_embedded_ok(self) -> None:
...
class TestFontSubsetting:
    ...
    def test_subsetted_font_no_finding(self) -> None:
    ...
    def test_not_subsetted_advisory(self) -> None:
...
class TestStandard14:
    ...
    def test_standard_14_advisory(self) -> None:
    ...
    def test_non_standard_14_no_finding(self) -> None:
...
class TestType3:
    ...
    def test_type3_delay(self) -> None:
...
class TestCIDFonts:
    ...
    def test_cid_missing_tounicode(self) -> None:
        font = _make_font(
    ...
    def test_cid_with_tounicode_ok(self) -> None:
        font = _make_font(
    ...
    def test_cid_missing_system_info(self) -> None:
        font = _make_font(
            font_type="CIDFontType0",
...
class TestFontEncoding:
    ...
    def test_no_encoding_advisory(self) -> None:
    ...
    def test_with_encoding_ok(self) -> None:
...
class TestTrueTypeEmbedding:
    ...
    def test_truetype_not_embedded_aground(self) -> None:
        font = _make_font(
            base_font="Arial",
            font_type="TrueType",
            embedded=False,
...
class TestDeduplication:
    ...
    def test_same_font_two_pages(self) -> None:
        font = _make_font(base_font="CustomFont", embedded=False)
