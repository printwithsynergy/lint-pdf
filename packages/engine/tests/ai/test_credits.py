"""Tests for AI credit metering (grounded.ai.credits)."""
...
class TestGetCreditBalance:
    ...
    def test_returns_zero_balance_when_no_config(
        ...
        from grounded.ai.credits import get_credit_balance
...
class TestCheckAICredits:
    ...
    def test_passes_with_sufficient_package_credits(
        ...
        with patch("grounded.ai.credits.get_credit_balance") as mock_balance:
