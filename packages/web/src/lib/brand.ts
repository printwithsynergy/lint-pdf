...
export const glossary = [
  ...
  {
    concept: "Per-tenant white-label rendering. Tenants can maintain multiple BrandProfiles, with one marked as default.",
    term: "White Label",
...
export const pricingTiers: PricingTier[] = [
  {
    ...
    features: [
      ...
      "Basic Ruleset",
      "JSON output only",
      "500+ Checks + PDF/X-4 conformance suite (91)",
      "Community support",
    ],
    cta: "Start Free",
    href: "/beta/join",
  ...
  },
  {
    ...
    features: [
      ...
      "500 included AI credits / month",
      "Custom Rulesets",
      "PDF, JSON & XML reports",
      "Webhooks",
      "Workflows + Brand Specs + Decisions audit",
      "EPM verdict + LLM cost cap",
      "500+ Checks + PDF/X-4 conformance suite (91)",
      "Priority support",
    ],
    cta: "Get Started",
  ...
  },
  {
    ...
    features: [
      ...
      "2,500 included AI credits / month",
      "White Label",
      "Custom Rulesets",
      "Priority Queue",
      "Webhooks + Workflows",
      "Brand Specs + Decisions audit + LLM cost cap",
      "AI-Explain on every finding",
      "PDF, JSON & XML reports",
    ],
    cta: "Get Started",
    href: "/beta/join",
  ...
  },
  {
    ...
    features: [
      "Unlimited files",
      "25,000 included AI credits / month",
      "Full White Label",
      "Custom Rulesets",
...
export const comparisonFeatures: ComparisonFeature[] = [
  ...
  {
    name: "PDF/X-4 conformance suite (ISO 15930-7)",
    free: true,
    viewer: false,
    starter: true,
    growth: true,
  ...
  {
    name: "EPM verdict (HP CMY-only Extended Print Mode)",
    free: true,
    viewer: false,
    starter: true,
    growth: true,
  ...
  {
    name: "AI-Explain (per-finding plain-English explanations)",
    free: false,
    viewer: false,
    starter: "When AI enabled",
    growth: "When AI enabled",
    scale: true,
    enterprise: true,
  },
  {
    name: "LLM cost cap (per-tenant monthly ceiling)",
    free: false,
    viewer: false,
    starter: false,
    growth: true,
  ...
  {
    name: "Decisions audit (approval-chain tracking)",
    free: false,
    viewer: false,
    starter: false,
    growth: true,
...
export const comparisonDimensions: ComparisonDimension[] = [
  ...
  },
  {
    ...
    values: {
      lintpdf: { type: "highlight", value: "500+ + PDF/X-4 (91)" },
