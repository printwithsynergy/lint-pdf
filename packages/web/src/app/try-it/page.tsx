          ...
          {state === "success" ? (
            <div className="rounded-2xl border border-brand-200 bg-brand-50/50 p-8 text-center">
              ...
              <p className="text-slate-500">
                We&rsquo;ll review your files and send you a detailed preflight
                report. Expect to hear from us within 1 business day.
              </p>
            </div>
          ) : (
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <p className="text-xs text-slate-400 text-center">
                Your files are scanned for security and only used for preflight
                analysis. We&rsquo;ll never share them.
              </p>
            </form>
          )}
        </div>
