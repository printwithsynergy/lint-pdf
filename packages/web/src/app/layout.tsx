...
export const metadata: Metadata = {
  title: "LintPDF — PDF Preflight API | Preflight. Perfected.",
  description:
  ...
  openGraph: {
    title: "LintPDF — PDF Preflight API | Preflight. Perfected.",
    description:
      "Detection-only PDF preflight engine. 250+ checks. PDF/X-4, PDF/A, GWG 2022 compliance. White-labeled reports. Zero file modifications.",
    type: "website",
