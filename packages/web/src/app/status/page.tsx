...
export const metadata: Metadata = {
  ...
  description:
    "Queue — real-time system status for the LintPDF PDF preflight engine.",
};
...
const systems = [
  ...
  { name: "Queue", description: "File processing queue and preflight engine" },
  {
    ...
    description: "PDF, JSON, and XML Report rendering",
  },
    ...
    <main className="py-16">
      <div className="mx-auto max-w-3xl px-6">
        ...
        <p className="mt-8 text-center text-sm text-slate-400">
          Last checked: {new Date().toISOString().split("T")[0]} &middot;
