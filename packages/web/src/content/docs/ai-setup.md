...
description: "How to enable and configure AI-powered preflight inspections on your Never Grounded account."
---
...
- An active Never Grounded account on a paid plan (Starter, Growth, Scale, or Enterprise)
- AI features enabled on your account (request access via sales@nevergrounded.io)
- A valid Boarding Pass (API key)

## Step 1: Request Access

Email sales@nevergrounded.io with your account ID and a brief description of your use case. We enable AI features on accounts individually during the alpha period.

Once enabled, you will see an "AI Inspections" section in The Bridge under Settings.

## Step 2: Configure AI Categories

Navigate to **Settings > AI Inspections** in The Bridge. You can enable or disable entire categories:
...
Enabled categories are applied to all Launches that include AI inspections. You can also override categories per-request (see AI Voyage Plans documentation).
...
## Step 5: Submit a Launch with AI

Include the `ai_preset` or `ai_categories` field in your Launch request:
...
After submitting a Launch with AI enabled, the Captain's Log will include AI findings with `source: "ai"` alongside core engine findings. Check your credit balance in The Bridge or via the API:
