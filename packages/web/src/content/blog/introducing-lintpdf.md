...
You send a PDF (or EPS, TIFF, JPEG, PNG, AI file) to the Submit endpoint with a Ruleset — a preflight profile defining which checks to run. LintPDF processes your file through 255+ checks: fonts, color spaces, images, transparency, overprint, page geometry, ink coverage, barcode grading, PDF/X-4, PDF/A compliance, and more.
