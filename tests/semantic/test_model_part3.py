...
class TestPdfAnnotation:
    ...
    @staticmethod
    def test_basic_annotation() -> None:
    ...
    @staticmethod
    def test_annotation_with_rect() -> None:
...
class TestSemanticPageAnnotations:
    ...
    @staticmethod
    def test_with_annotations() -> None:
        annots = [
